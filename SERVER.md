...
We try to make it as secure and robust as possible but if you want to be absolutely sure that traffic from VPN server cannot flow ti your infrastructure, use backend proxy ACLs or iptables.
